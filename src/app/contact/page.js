...
export default function Contact() {
    ...
    return (
        <div className="min-h-screen bg-[#0f1216] text-[#E0E0E0] flex flex-col items-center justify-center p-6 relative overflow-hidden">
            {/* Background Ambience */}
            ...
            <div className="z-10 w-full max-w-4xl flex flex-col md:flex-row bg-[#1a1d2c] rounded-3xl shadow-2xl overflow-hidden border border-white/5">

                {/* Info Section */}
                <div className="md:w-1/3 bg-gradient-to-br from-[#7C4DFF] to-[#00B4D8] p-10 text-white flex flex-col justify-between">
                    <div>
                ...
                {/* Form Section */}
                <div className="md:w-2/3 p-10 bg-[#1a1d2c]">
